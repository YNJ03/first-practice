...
urlpatterns = [
    ...
    ### [상품 주문하기]
    # - http://127.0.0.1:8000/oracle/product_list
    path('product_list/', views.getProductList),
    
    ### [상품 주문하기]
    # - http://127.0.0.1:8000/oracle/product_insert
    path('product_insert/', views.setProductInsert),
    
    ### [상품 주문하기]
    # - http://127.0.0.1:8000/oracle/product
