...
from thirdapp import views as views3
from mainapp import views as views4
...
urlpatterns = [
    ...
    #             : include가 실행되는 순간 해당 파일의 코드에서 처리가 됨
    ...
    path('index/', views4.Index),
    # - http://127.0.0.1:8000/index.html/
    path('index.html/', views4.Index),
    ...
    ### 아래는 사용안함(각 앱에서 처리하게 했음)............xxxxxxxxxxxxx
