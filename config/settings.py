...
SECRET_KEY = 'django-insecure-n+oo5w=akcl!&-u0d-x(67szsmz-shw9$j*8h8)n&%v+@ca70h'
...
DATABASE_ROUTERS = [
    ### 앱이름.router파일이름.클래스이름(클래스이름은 바뀔 수 있음) - 매핑
